...
/usr/bin/docker run -p 8081:8081 -d --name "$appName" "$appName":latest --net novel-tier -e dburl=\"jdbc:mysql://mysql:3306/novel?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai\" -e username=\"novel\" -e password=\"novel\"
